        ...
        <div className="bg-white rounded-lg p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-purple-600">{t('email')}</label>
              <Input
                type="email"
                name="email"
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-purple-600">{t('password')}</label>
              <Input
                type="password"
                name="password"
            ...
            <div className="text-center">
              <span className="text-sm text-gray-600">{t('dont_have_account')} </span>
