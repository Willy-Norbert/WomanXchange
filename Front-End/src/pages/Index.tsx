...
const Index = () => {
    ...
    return (
      <div className="min-h-screen bg-white">
        ...
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-lg text-gray-600">{t('loading_products')}</div>
        </div>
        <Footer />
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-white">
      <Header />
      <HeroSection />
      <ProductSection title={t('new_arrivals')} products={newArrivals} />
      <ProductSection title={t('top_selling')} products={topSelling} />
      <CategorySection />
      <TestimonialSection />
      <Footer />
    </div>
